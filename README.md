...
[![GitHub release](https://img.shields.io/badge/release-v1.0.5-green.svg)](https://github.com/Thor-jelly/MaxNumEditText/releases)
...
2. Add the dependency
    ...
    ```
        dependencies {
	        compile 'com.github.Thor-jelly:MaxNumEditText:v1.0.5'
	}
    ```
